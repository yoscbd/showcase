...
function display_acf_img($field_name, $size){
	$image = get_field($field_name);
	$size = $size; // (thumbnail, medium, large, full or custom size)
	if( $image ) {
 ...
 add_action( 'wp_head', 'ybd_load_fonts' ); 
 function ybd_load_fonts() { 
	 ?> 

<link rel="preload" href="<?= get_template_directory_uri() ?>/fonts/RecifeTextWebTrial-Regular.woff2" as="font" type="font/woff2" crossorigin="anonymous" >
<link rel="preload" href="<?= get_template_directory_uri() ?>/fonts/FontsFree-Net-GT-America-Regular-1.woff2" as="font" type="font/woff2" crossorigin="anonymous" >

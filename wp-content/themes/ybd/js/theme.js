...
(function (global, factory) {
	...
	*/
	...
	class MyNotes {
		...
		events() {
			$__default["default"]("#my-notes").on("click", ".delete-note", this.deleteNote);
			$__default["default"]("#my-notes").on("click", ".edit-note", this.editNote.bind(this));
			$__default["default"]("#my-notes").on("click", ".update-note", this.updateNote.bind(this));
			$__default["default"](".submit-note").on("click", this.createNote.bind(this));
		} // Methods will go here


		editNote(e) {
			var thisNote = $__default["default"](e.target).parents("li");
		...
		createNote(e) {
			...
			let itemsNumber = $__default["default"]("#my-notes li").length;
			var ourNewPost = {
				"title": $__default["default"](".new-note-title").val(),
				//"content": $(".new-note-body").val(),
				"status": "publish"
			};

			if ($__default["default"](".new-note-title").val()) {
				$__default["default"](".note_users-message").hide();
				$__default["default"].ajax({
					beforeSend: xhr => {
						xhr.setRequestHeader("X-WP-Nonce", globalData.nonce);
					},
					...
					data: ourNewPost,
					success: response => {
						$__default["default"](".new-note-title, .new-note-body").val("");
						$__default["default"](`
          ...
          `).prependTo("#my-notes").hide().slideDown();
						console.log("Congrats");
						console.log(response);
						itemsNumber >= 5 ? $__default["default"]('#my-notes li:last-child').hide() : '';
					},
					error: response => {
						console.log("Sorry");
						console.log(response);
				...
				$__default["default"](".note_users-message").show();
			}
		}
	...
	class Like {
		...
		events() {
			$__default["default"](".like-box").on("click", this.ourClickDispatcher.bind(this));
		} // methods


		ourClickDispatcher(e) {
			var currentLikeBox = $__default["default"](e.target).closest(".like-box");
		...
		createLike(currentLikeBox) {
			$__default["default"].ajax({
				...
				url: globalData.root_url + "/wp-json/university/v1/manageLike",
				type: "POST",
				data: {

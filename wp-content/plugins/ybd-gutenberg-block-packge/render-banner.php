...
//http://127.0.0.1/custom/wp-content/uploads/2022/08/Group-2074-2222.webp

function render_banner($attributes)
{
    $image_id = 34;
    if (isset($attributes['imgID'])) {
        $image_id = $attributes['imgID'];
    }
    ...
    ob_start();?>
<section class="section-first" style="background-color: <?php echo $attributes['banner_background_color'] ?>">
    <div>
        <div class="banner-title">
            <h4 style="color: <?=$attributes['banner_small_title_color'];?>"><?php echo $attributes['first_title']; ?>
            </h4>
        </div>
    </div>
    <div>
        <div class="banner-main-section">
            <div class="left">
                <h3 style="color: <?php echo $attributes['banner_large_title_color']; ?>">
    ...
    <div>
        <div class="banner-cta">
            <button
                style="color: <?php echo $attributes['banner_cta_text_color'] ?>; background:<?php echo $attributes['banner_cta_bg_color'] ?> "
                type="button"> <?php echo $attributes['btn_text']; ?>
            </button>
        </div>
    </div>
</section>
